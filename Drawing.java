 ...
 * 
 * This class creates the side bar for the game which includes information such
 * as player name, score and piece colour. This is also updated as the game
 * continues.
 * 
 */
public class Drawing {
	...
	/**
	 * Method responsible for setting AI move to GameBoardGraphics class \param
	 * move - coordinate of AI move
	 */
	 ...
	 * \param type - type of animation that is either flip or fall \param
	 * changes - the list stores the pieces which need the animation
	 */
	...
	/**
	 * This method sets the player 1 score on the side bar. \param Score This
	 * hold the score for player 1 in an integer form.
	 */
	...
	/**
	 * This method sets the player 2 score on the side bar. \param Score This
	 * hold the score for player 2 in an integer form.
	 */
	...
	/**
	 * This method returns the sidebar panel for player 1. \return This method
	 * retrives the score from the game for player 1
	 */
	...
	/**
	 * This method returns the sidebar panel for player 2. \return This method
	 * retrives the score from the game for player 1
	 */
	...
	/**
	 * This method sets the name of player 1. \param label This stores the name
	 * of player 1
	 */
	...
	/**
	 * This method sets the name of player 2. \param label This stores the name
	 * of player 2
	 */
	...
	/**
	 * This method returns the name of player 1. \return m_player1Name This
	 * returns the name of player 1 when called
	 */
	...
	/**
	 * This method returns the name of player 2. \return m_player2Name This
	 * returns the name of player 2 when called
	 */
	 ...
	 * stores it. \param label This stores the information on the amount of
	 * turns taken
	 */
	...
	/**
	 * This method returns the number of turns that has been made. \return
	 * m_turnsTaken This returns the amount of turns taken in the game
	 */
	 ...
	 * player 1. \param label This stores the information on the piece colour of
	 * player 1
	 */
	...
	/**
	 * This method assigns the information on the colour of the piece chosen by
	 * player 2. \param label This stores the information on the piece colour of
	 * player 2
	 */
	...
	/**
	 * This returns the colour of the piece chosen by player 1. \return
	 * m_player1Piece This returns the colour of the player 1 piece
	 */
	...
	/**
	 * This returns the colour of the piece chosen by player 2. \return
	 * m_player2Piece This returns the colour of the player 2 piece
	 */
	...
	/**
	 * This method sets the the player 1 side bar. \param panel Instantiates
	 * m_barPlayer1 with JPanel
	 */
	...
	/**
	 * This method sets the the player 2 side bar. \param panel Instantiates
	 * m_barPlayer2 with JPanel
	 */
	...
	/**
	 * This method returns the relevant iformation on the player 1 game panel.
	...
	/**
	 * This method returns the relevant iformation on the player 2 game panel.
	...
	/**
	 * This method returns the graphics that were created. \return Returns the
	 * GameBoardGrpahics when it is called.
	 */
	...
	/**
	 * This method returns the side bar that was created. \return Returns the
	 * side bar which holds the scores for the game.
	 */
	...
	/**
	 * This method sets all relevent information for Player 1 \param Player1
	 * This is an object which holds data for player 1.
	 */
	public void setPlayer1(Player Player1) {
		boolean m_Trace = false;

		getPlayer1Name().setText(Player1.getPlayerName());
		m_p1piece = new BufferedImage(OVALSIZE, OVALSIZE,
		...
		if (m_Trace)
			System.out.println("Drawing::SetPlayer1() - colour is "
					+ Player1.getPlayerColour());
		getPlayer1Piece().setIcon(new ImageIcon(m_p1piece));
	}

	/**
	 * This method sets all relevent information for Player 2 \param Player2
	 * This is an object which holds data for player 2.
	 */
	public void setPlayer2(Player Player2) {
		boolean m_Trace = false;

		getPlayer2Name().setText(Player2.getPlayerName());
		m_p2piece = new BufferedImage(OVALSIZE, OVALSIZE,
				BufferedImage.TYPE_3BYTE_BGR);
		...
		g2.fillOval(0, 0, OVALSIZE, OVALSIZE);
		if (m_Trace)
			System.out.println("Drawing::SetPlayer2() - colour is "
					+ Player2.getPlayerColour());
	 ...
	 * taken. \param isAI indicates if the turn is an AI turn
	 */
	public void setPlayerTurn(Game.PlayerTurn PlayerTurn, boolean isAI) {
		...
		if (PlayerTurn == Game.PlayerTurn.PLAYER1) {
			...
			BufferedImage Piece = new BufferedImage(OVALSIZE, OVALSIZE,
					BufferedImage.TYPE_3BYTE_BGR);
	...
	/**
	 * This method sets the grid. \param grid Holds information on the grid,.
	 */
	public void setGrid(Grid grid, Game game) {
		...
		if (m_Trace)
			System.out.println("Drawing::SetGrid() - Grid has been updated");
	...
	/**
	 * \param game This receives an instance of the Game class. \param handler
	 * This receives the GUIEventHandler for the combobox and slider This method
	 * creates layout of the sidebar
	 */
	...
	/**
	 * \param game This creates an instance of the Game class. This method
	 * creates the panel and layout for the game to be played on, and adds the
	...
	public Drawing(Game game) {
		...
		if (m_Trace) {
			System.out.println("Drawing::Drawing() - drawing initalizing");
		}

		if (m_Trace) {
			System.out.println("Drawing::Drawing() - Grid size = "
					+ game.getGrid().getGridWidth() + "X"
					+ game.getGrid().getGridHeight());
		}
		if (m_Trace) {
			System.out.println("Drawing::Drawing() - Players = "
					+ game.getPlayer2().getPlayerName() + ":"
					+ game.getPlayer1().getPlayerName());
		}
		try {
			gameBoardGraphics = new GameBoardGraphics(game.getGrid(),
